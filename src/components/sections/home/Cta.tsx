...
const DEFAULT_CTA = {
  ...
  mainTitleHighlight: "Digital Presence?",
  description: "Join thousands of successful businesses who have chosen our platform. Start your journey today with a free trial and see the difference.",
  ...
  stat4Value: "24/7",
  stat4Label: "Support",
  feature1Title: "Free Trial",
  feature1Description: "14 days free, no credit card required",
  feature2Title: "Secure & Reliable",
  feature2Description: "Enterprise-grade security and 99.9% uptime",
  feature3Title: "Easy Setup",
  feature3Description: "Get started in minutes with our guided setup"
} as const
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="space-y-2">
                  <div className={`size-12 mx-auto rounded-full ${feature.bgColor} flex items-center justify-center mb-3`}>
                    {Icon ? (
                  ...
                  <p className="text-sm text-muted-foreground">
                    <span data-editable={`feature${index + 1}Description`}>{feature.description}</span>
                  </p>
                </div>
              )
            })}
