...
const DEFAULT_FOOTER = {
  logoText: 'CloudFlow',
  companyDescription:
    'Streamline your business operations with our comprehensive SaaS platform. Trusted by over 10,000 companies worldwide to automate workflows, manage teams, and scale efficiently.',
  contactEmail: 'support@cloudflow.com',
  ...
  section4Title: 'Legal',
  copyrightText: '© 2024 CloudFlow. All rights reserved.',
  madeWithText: 'by our engineering team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/cloudflow',
  social2Href: 'https://facebook.com/cloudflow',
  social3Href: 'https://instagram.com/cloudflow',
  social4Href: 'https://linkedin.com/company/cloudflow',
  social5Href: 'https://github.com/cloudflow',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: 'About CloudFlow', href: '/about', editableId: 'link-footer-about' },
